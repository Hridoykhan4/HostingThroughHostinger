...
Below are command line for getting the CERTBOT , follow step by step:(New)

certbot

##locate your domain address example: abc.com, www.abc.com, api.abc.com

## IT will be listed by numbers 1,2,3
## After getting the list number of your desired domain press enter.
